...
import com.bannirui.spring.security.config.auth.MyLogoutSuccessHandler;
import com.bannirui.spring.security.config.auth.MyUserDetailsService;
import com.bannirui.spring.security.config.auth.jwt.JwtAuthenticationTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf()
                ...
                .ignoringAntMatchers("/spring-security/authentication", "/spring-security/hello/test")  // 路由访问放行
                .and().cors().and()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/spring-security/authentication", "/refreshToken").permitAll()  // 不设置鉴权
