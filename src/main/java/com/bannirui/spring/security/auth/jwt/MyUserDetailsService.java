...
import com.bannirui.spring.security.auth.dal.model.*;
import com.bannirui.spring.security.auth.service.*;
...
public class MyUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        MyUserDetails myUserDetails = User.toMyUserDetails(user);
