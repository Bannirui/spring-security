...
`role_name` VARCHAR ( 32 ) COLLATE utf8_bin NOT NULL COMMENT '角色名 中文',
`role_desc` VARCHAR ( 128 ) COLLATE utf8_bin NOT NULL COMMENT '角色描述',
`role_code` VARCHAR ( 32 ) COLLATE utf8_bin NOT NULL COMMENT '角色代号 英文 如admin',
...
`id` INT ( 11 ) NOT NULL AUTO_INCREMENT,
`menu_name` VARCHAR ( 64 ) COLLATE utf8_bin DEFAULT NULL COMMENT '权限名',
`url` VARCHAR ( 64 ) COLLATE utf8_bin DEFAULT NULL COMMENT '访问路径',
PRIMARY KEY ( `id` ),
